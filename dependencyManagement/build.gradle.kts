...
val otelVersion = "2.31.0"
val otelSnapshotVersion = "2.32.0"
...
val dependencyLists = listOf(
  ...
  "io.opentelemetry.contrib:opentelemetry-aws-xray:1.59.0-adot1",
  "io.opentelemetry.contrib:opentelemetry-aws-resources:1.59.0-alpha",
